...
#
# ⚠️ ОДНОРАЗОВЫЙ СКРИПТ-СНИМОК (2026-08-31). Отражает решения владельца на эту
# дату для этой конкретной машины. НЕ универсальный клинер, НЕ для повторных
# запусков без ревизии: список целей устаревает (база могла снова понадобиться,
# приложение — вернуться). Перед любым повторным запуском перечитай docs/decisions.md.
#
